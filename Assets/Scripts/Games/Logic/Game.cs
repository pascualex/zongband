...
namespace Zongband.Games.Logic
{
    public class Game<T> : IGame
    {
        ...
        public Game(IGameData<T> data, IGameView<T> view)
        {
            ...
            VBoard = new(data.Board, view.Board);
